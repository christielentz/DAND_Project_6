...
ggplot(aes(density, alcohol), data=wines)+
  geom_point(aes(color=residual.sugar.bucket), alpha=1/10)+
...
ggplot(aes(density, alcohol), data=wines)+
  geom_point(aes(color=quality.bucket, shape=residual.sugar.bucket), alpha=0.8)+
...
ggplot(aes(density, alcohol), data=wines)+
  geom_point(aes(color=chloride.bucket, shape=residual.sugar.bucket), alpha=0.8)+
  labs(shape='Residual Sugar')+
  xlim(quantile(wines$density, 0.01), quantile(wines$density, 0.99))+
  scale_color_brewer(palette="RdYlBu",
                     name='Chloride\nLevels',
...
ggplot(aes(density, alcohol), data=wines)+
  geom_point(aes(color=bound.SO2.bucket, shape=residual.sugar.bucket), alpha=0.8)+
  labs(shape='Residual Sugar')+
  xlim(quantile(wines$density, 0.01), quantile(wines$density, 0.99))+
  scale_color_brewer(palette="RdYlBu",
                     name='Bound\nSulfur\nDioxide\nLevels',
...
ggplot(aes(density, alcohol), data=wines)+
  geom_point(aes(color=volatile.acidity.bucket, 
                  shape=residual.sugar.bucket), alpha=.8)+
  labs(shape='Residual Sugar')+
  xlim(quantile(wines$density, 0.01), quantile(wines$density, 0.99))+
  scale_color_brewer(palette="RdYlBu",
                     name='Volatile\nAcidity',
